...
class WorkerTests(unittest.TestCase):
    ...
    def test_initialization(self):
        worker = Worker('Petar Petrov', 1000, 10)
        self.assertEqual(worker.name, 'Petar Petrov')
    ...
    def test_work_devreases_energy(self):
        worker = Worker('Petar Petrov', 1000, 10)
        worker.work()
    ...
    def test_get_info_returns_proper_string(self):
        worker = Worker('Petar Petrov', 1000, 10)
        self.assertEqual(worker.get_info(), f'Petar Petrov has saved 0 money.')
