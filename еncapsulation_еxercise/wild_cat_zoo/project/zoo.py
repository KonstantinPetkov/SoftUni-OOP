...
class Zoo:
    ...
    def animals_status(self):
        # lions = list(filter(lambda a: a.__class.__name__ == "Lion", self.animals))
        # tiger = list(filter(lambda a: a.__class.__name__ == "Tiger", self.animals))
        # cheetah = list(filter(lambda a: a.__class.__name__ == "Cheetah", self.animals))
